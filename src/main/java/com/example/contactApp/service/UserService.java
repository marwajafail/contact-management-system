...
import com.example.contactApp.repository.ProfileRepository;
import com.example.contactApp.repository.RoleRepository;
import com.example.contactApp.repository.UserRepository;
import com.example.contactApp.security.JWTUtils;
import com.example.contactApp.security.MyUserDetails;
...
public class UserService {
    ...
    public GenericDao<UserDto> createUser(UserDto dto) throws MessagingException, UnsupportedEncodingException {
        ...
        if (errors.isEmpty()) {
            Optional<User> retrievedUser = userRepository.findByEmail(dto.getEmail());
    ...
    private void sendVerificationEmail(User user)
        ...
        String fromAddress = "contactmanagementa@gmail.com";
        String senderName = "Contact Management App";
